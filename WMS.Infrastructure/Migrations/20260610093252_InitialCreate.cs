        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalHours = table.Column<double>(type: "float", nullable: true, computedColumnSql: "CASE WHEN CheckOut IS NOT NULL THEN DATEDIFF(MINUTE, CheckIn, CheckOut) / 60.0 ELSE NULL END", stored: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 10, 15, 2, 52, 198, DateTimeKind.Local).AddTicks(8291), "Human Resources", "HR Department" },
                    { 2, new DateTime(2026, 6, 10, 15, 2, 52, 198, DateTimeKind.Local).AddTicks(8303), "Information Technology", "IT Department" },
                    { 3, new DateTime(2026, 6, 10, 15, 2, 52, 198, DateTimeKind.Local).AddTicks(8304), "Finance", "Finance Department" },
                    { 4, new DateTime(2026, 6, 10, 15, 2, 52, 198, DateTimeKind.Local).AddTicks(8305), "Operations", "Operations Department" }
                });
